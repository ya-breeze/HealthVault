...
export default function DayCompletenessControl({ date, state, onChange }: Props) {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <TapTarget
          ...
          disabled={pending}
          className="flex items-center text-xs text-gray-500 dark:text-gray-400 hover:underline disabled:opacity-50"
        >
  ...
  return (
    <TapTarget
      ...
      disabled={pending}
      className="flex items-center text-xs font-medium px-2 rounded-full border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 disabled:opacity-50"
    >
