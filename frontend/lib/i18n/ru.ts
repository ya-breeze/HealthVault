...
const ru: Dictionary = {
  ...
  'loggingGap.targetCalorieDerivation':
    'Калории: базовый обмен {bmr} ккал (формула Миффлина — Сан-Жеора) при весе {weight} кг, росте {height} см, возрасте {age}, поле «{sex}», умноженный на коэффициент активности {multiplier} ({tier}), даёт {calories} ккал.',
