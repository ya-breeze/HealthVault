...
const ru: Dictionary = {
  ...
  'loggingGap.adviceDetail':
    'Эти строки пишет ИИ на основе оценки, её кодов причин и вашей цели по питанию. Они кэшируются на текущий день и создаются заново, когда меняются эти данные или вы запрашиваете новый совет. Это не медицинская рекомендация.',
