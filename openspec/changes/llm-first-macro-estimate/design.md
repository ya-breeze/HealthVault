...
- No individual per-100g macro (protein, carbs, fat) exceeds 100g, and their sum does not exceed 102g. The 2g total-mass tolerance absorbs model rounding while still rejecting internally impossible profiles such as 80g protein + 80g carbs + 80g fat per 100g of food.
- `sugar_per_100g` does not exceed `carbs_per_100g` by more than 2g, and `dietary_fiber_per_100g` does not exceed `carbs_per_100g` by more than 2g; both are subsets of carbs and the allowance absorbs model rounding.
