...
- Add a resolution-time plausibility check for `estimated_profile` beyond today's non-negativity check: protein, carbs, and fat must each be at most 100g/100g and total at most 102g/100g (a 2g rounding allowance); sugar and fiber may exceed carbs by at most 2g/100g; and declared calories may fall below the protein/carbs/fat Atwater calculation by at most the larger of 25 kcal or 15% of that calculation. An estimate failing this check is treated the same as "no usable estimate" for automatic-resolution precedence purposes.
